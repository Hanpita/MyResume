...
*/
/* jquery-core: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-includes/js/jquery/jquery.js) */
...
/* jquery-migrate: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-includes/js/jquery/jquery-migrate.min.js) */
...
/* qfe_composer_front_js: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-content/plugins/qfy_editor/assets/js/qfy_editor_front.js) */
...
/* vc_transition_bootstrap_js: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/transition.js) */
+function ($) { "use strict";
...
/* vc_carousel_js: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/vc_carousel.js) */
/* ========================================================================
...
/* waypoints: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/jquery-waypoints/waypoints.min.js) */
...
/* jquery-blockui: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-blockui/jquery.blockUI.min.js) */
/*!
...
/* dt-plugins: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-content/themes/qfy-01/js/plugins.js) */
/*jquery-parallax*/
/*scroll 用到*/
...
/* dt-main-op-jquery: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/FeiEditor/bitSite/js/opentip-jquery.min.js) */
// Opentip v2.4.6
...
/* dt-language: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-content/themes/qfy-01/js/language.js) */
jQuery(function(){
...
/* dt-main: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-content/themes/qfy-01/js/main.js) */
//悬浮效果
...
function shape_ready(){
	...
	if(typeof anime=="undefined"){
		$.getScript("/FeiEditor/bitSite/js/anime.min.js").done(function() {
...
function nav_customsearch(obj,customurl){
	...
	if(customurl){
		...
		url = url.replace(/q_term-type_\d*=-?[^&]*&/g,"");
			...
			jQuery(this).find("li.active").each(function(){
				if(len>1  ){
					if( jQuery(this).attr("data-id")!="-1"){
						ids[n]= encodeURIComponent(jQuery(this).attr("data-id"));
						n++;
					}
				}else{
					ids[n]= encodeURIComponent(jQuery(this).attr("data-id"));
	...
	if(p.attr("data-ajax")=="1"){
		...
		if( $("#qfy_custom_ad_search").length >0 ){
			url = url.replace(/&csearch=[^&]*/g,"");
			url = url+"&csearch="+$("#qfy_custom_ad_search").val();
		}
...
/* thickbox: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-includes/js/thickbox/thickbox.js) */
/*
...
/* jquery-lazy: (http://w-98611-75517-96671.47100253128.sites.cnfree05.qifeiye.com/qfy-includes/js/jquery.lazy.min.js) */
